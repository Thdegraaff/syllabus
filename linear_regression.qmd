...
#| label: scatterplot
scatter testscr str
quietly graph export figures/scatter.png, replace
```

And this provides the following `STATA` output.

```{r fig.align='center', echo=FALSE, fig.cap = "A scatterplot with tests-cores on the $y$-axis and student-teacher ratio on the $x$-axis", label='fig-scattercaschool', out.width="600px"}
