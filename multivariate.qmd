...
```{r fig.align='center', echo=FALSE, fig.cap = "A non-linear relation", label='scatterqua', out.width="600px"}
...
kable(df, 
      align="l", 
      booktabs=TRUE, escape = F, 
      caption = 'Interpretation of interaction effects with dummies',
...
```{r fig.align='center', echo=FALSE, fig.cap = "Three possible binary-continuous interaction outcomes", label='interaction', out.width="600px"}
...
```{r fig.align='center', echo=FALSE, fig.cap = "Predicted population regression lines of districts with large and small percentage english learners", label='interactionplot', out.width="600px"}
...
```{r fig.align='center', echo=FALSE, fig.cap = "A non-linear relation", label='scatterlnincome', out.width="600px"}
...
```{r fig.align='center', echo=FALSE, fig.cap = "A non-linear relation", label='scattercompare', out.width="600px"}
