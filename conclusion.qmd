...
After finishing this course you should have a good understanding of the basics of applied econometrics. More advanced courses always go back go this and especially to the least squares assumptions as defined in @sec-lsa. All more advanced techniques are only used becuase one of these assumptions (typically the first one) are violated. Finally, understanding this also allows you to read and understand most empirical findings as displayed in empirical economic articles. 